          ...
          <div className="max-w-4xl mx-auto p-6 text-center space-y-12">
            <div className="mt-12 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
                <button 
                  ...
                  className="px-8 py-4 bg-white text-indigo-600 border-2 border-indigo-600 rounded-xl font-bold text-lg hover:bg-indigo-50 transition-colors shadow-sm"
                >
                  Lire le cours
                </button>
                <button 
                  onClick={() => setCurrentView(ViewState.PRACTICE)}
                  className="px-8 py-4 bg-indigo-600 text-white rounded-xl font-bold text-lg hover:bg-indigo-700 transition-colors shadow-lg flex items-center justify-center gap-2"
                >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left mt-16">
              <div 
                ...
                onClick={() => setCurrentView(ViewState.ASSESSMENT)}
              >
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <footer className="bg-white border-t border-gray-200 py-6 text-center text-gray-500 text-sm">
        <p>&copy; 2024 Stat'Master 3ème - Conçu pour la réussite au Brevet des Collèges.</p>
      </footer>
    </div>
  );
};
